...
In Python you can use the [`pycallgraph`](https://pycallgraph.readthedocs.io/) library to generate them.【CS61A】
...
1. Here's some (arguably convoluted) Python code for computing Fibonacci numbers using a function for each number.
   ...
   if __name__ == '__main__':
       ...
       # for n in range(10):
       #     exec("fib{} = lru_cache(1)(fib{})".format(n, n)) # FOR the FIRST time, meet the lru here!
       print(eval("fib9()"))
   ```
